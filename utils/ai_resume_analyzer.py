...
class AIResumeAnalyzer:
    ...
    def analyze_resume_with_gemini(self, resume_text, job_description=None, job_role=None):
        """Analyze resume using Groq Llama model"""
        if not resume_text:
    ...
    def analyze_resume(self, resume_text, job_role=None, role_info=None, model="Groq Llama 3.3 70B"):
        """
        ...
        - model: The AI model to use ("Groq Llama 3.3 70B" or "Anthropic Claude")
